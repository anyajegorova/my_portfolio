...
//             <span style={{ fontWeight: 400 }}>holistic</span> and{" "}
//             <span style={{ fontWeight: 400 }}>modern</span> interfaces
//           </h4>
//           <h4 className={`${isVisible ? "visible" : ""}`}>
//             .. and turn them into code using{" "}
//             <span style={{ fontWeight: 400 }}>latest </span>
//             technologies
//           </h4>
//         </div>
